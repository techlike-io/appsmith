...
class GanttWidget extends BaseWidget<GanttWidgetProps, WidgetState> {
        ...
        children: [
          {
            ...
            helpText: "Input JSON sample for Gantt items",
            label: "Source Data",
        ...
        children: [
          {
            ...
            helpText: "Sets the view mode of Gantt chart.",
  ...
  componentDidUpdate(prevProps: GanttWidgetProps): void {
    if (
...
export interface GanttWidgetProps extends WidgetProps {
  sourceData: Task[];
