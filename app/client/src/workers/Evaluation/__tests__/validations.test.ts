...
describe("Validate Validators", () => {
  ...
  it("correctly validates number when required is true", () => {
    ...
    const expected = [
      ...
      },
      {
        isValid: false,
        parsed: 90,
        messages: [new RangeError("Minimum allowed value: 100")],
      },
      {
        isValid: false,
        parsed: 200,
        messages: [new RangeError("Maximum allowed value: 200")],
      },
      {
        isValid: false,
        parsed: 150,
  ...
  it("correctly validates number when required is false", () => {
    ...
    const expected = [
      ...
      },
      {
        isValid: false,
        parsed: -120,
        messages: [new RangeError("Minimum allowed value: -8")],
      },
      {
        isValid: true,
        parsed: -8,
  ...
  it("correctly validates boolean when required is true", () => {
    ...
    const expected = [
      {
        isValid: false,
        messages: [new TypeError(`${WIDGET_TYPE_VALIDATION_ERROR} boolean`)],
        parsed: false,
      },
      {
        isValid: false,
      ...
      },
      {
        ...
        parsed: false,
        messages: [
          new TypeError("This value does not evaluate to type boolean"),
        ],
      },
    ];
  ...
  it("correctly validates date iso string when required is true", () => {
    ...
    const expected = [
      ...
      },
      {
        isValid: false,
        parsed: defaultDate,
        messages: [new TypeError("Value does not match: ISO 8601 date string")],
      },
      {
        isValid: false,
        parsed: defaultDate,
  ...
  it("correctly validates object array when required is true", () => {
    ...
    const expected = [
      ...
      },
      {
        ...
        messages: [
          new TypeError("This value does not evaluate to type Array<Object>"),
        ],
      },
      {
        isValid: false,
  ...
  it("correctly validates safe URL", () => {
    ...
    const expected = [
      ...
      {
        isValid: false,
        messages: [new TypeError(`${WIDGET_TYPE_VALIDATION_ERROR}: URL`)],
        parsed: "https://www.example.com",
      },
      {
        isValid: false,
